...
const myInformation = ["Самира", 6, "декабря", "стрелец"];
...
russianCities2 = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
...
const numSum = numbers[0] + numbers[numbers.length - 1];
console.log(numSum);
...
const filterEvenNumbers = numbers.filter(el => el % 2 == 0);
